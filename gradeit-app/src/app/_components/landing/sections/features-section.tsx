...
const FeaturesSection = ({ features, AnimatedSection, StaggeredItem }:any) => {
  return (
    <section className="py-24 flex justify-center bg-card" id="features">
      <div className="container px-6">
        <AnimatedSection>
          <div className="mx-auto max-w-3xl text-center mb-16">
            <span className="inline-block text-sm font-medium text-muted-foreground mb-3">CAPABILITIES</span>
