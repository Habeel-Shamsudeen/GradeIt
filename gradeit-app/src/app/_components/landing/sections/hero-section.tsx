// _components/landing/sections/hero-section.js
import React from 'react'
import { Button } from '../../ui/button'
import { redirect } from 'next/navigation'
import Link from 'next/link'

const HeroSection = ({ heroOpacity, heroY, HeroCarousel, AnimatedSection, motion, ChevronRight }:any) => {
  return (
    <section className="relative overflow-hidden py-24 md:py-32 flex justify-center">
      ...
      <div className="container relative z-10 px-6">
        ...
        >
          ...
          >
            <Button size="lg" className="h-12 px-8 button-primary transition-all" >
              Get Started
